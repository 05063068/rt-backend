...
/**
 * API implementation for the {@link MovieListToMovieRepository} 'all-box-office' endpoint
 * 
 * @author harry
 */
public class MovieListToMovieAllBoxOfficeApiCall extends AbstractApiCall {

    public MovieListToMovieAllBoxOfficeApiCall(final Environment environment, final String fieldName,
