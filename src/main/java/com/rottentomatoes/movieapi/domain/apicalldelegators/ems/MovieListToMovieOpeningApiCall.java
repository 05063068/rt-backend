...
import com.rottentomatoes.movieapi.domain.requests.ems.EmsOpeningMoviesRequest;
...
public class MovieListToMovieOpeningApiCall extends AbstractApiCall {
    ...
    public List<Movie> process() {
        EmsOpeningMoviesRequest request = new EmsOpeningMoviesRequest(environment, fieldName, requestParams);
