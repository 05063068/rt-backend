...
public abstract class AbstractUserRatingsRequest extends AbstractJsonRequest {
    ...
    public AbstractUserRatingsRequest(final Environment environment, final HttpMethod httpMethod,
        ...
        super(httpMethod, prepareAbsoluteUrl(environment, relativeUrl), queryParameters, httpHeaders, apiStatName);
    }

    private static String prepareAbsoluteUrl(final Environment environment, final String relativeUrl) {
