...
@Component
public class MovieToItunesInfoRepository implements RelationshipRepository<Movie, String, ItunesInfo, String> {
    @Autowired
    ...
    @Override
    public ItunesInfo findOneTarget(String movieId, String fieldName, RequestParams requestParams) {
       return null;
    }

    @Override
    public Iterable<ItunesInfo> findManyTargets(String movieId, String fieldName, RequestParams requestParams) {
