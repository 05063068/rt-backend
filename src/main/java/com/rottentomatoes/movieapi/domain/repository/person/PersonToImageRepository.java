...
@Component
public class PersonToImageRepository extends AbstractRepository implements RelationshipRepository<Person, String, Image, String>, MetaRepository {
    ...
    @Override
    public MetaDataEnabledList<Image> findManyTargets(String personId, String fieldName, RequestParams requestParams) {
        ...
        List<Image> rawImageList = (List<Image>)emsClient.callEmsList(selectParams, "person", personId + "/image", TypeFactory.defaultInstance().constructCollectionType(List.class,  Image.class));
    ...
    public MetaInformation getMetaInformation(Object root, Iterable resources, Serializable castedResourceId, String fieldName, RequestParams requestParams) {
        ...
        EmsClient emsClient = emsRouter.fetchEmsClientForEndpoint(this.getClass());
        RelatedMetaDataInformation metaData = (RelatedMetaDataInformation) emsClient.callEmsEntity(selectParams, "person", castedResourceId + "/image/meta", RelatedMetaDataInformation.class);
