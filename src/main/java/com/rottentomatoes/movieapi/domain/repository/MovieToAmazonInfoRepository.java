...
@Component
public class MovieToAmazonInfoRepository implements RelationshipRepository<Movie, String, AmazonInfo, String> {
    @Autowired
    ...
    @Override
    public AmazonInfo findOneTarget(String movieId, String fieldName, RequestParams requestParams) {
        return null;
    }

    @Override
    public Iterable<AmazonInfo> findManyTargets(String movieId, String fieldName, RequestParams requestParams) {
