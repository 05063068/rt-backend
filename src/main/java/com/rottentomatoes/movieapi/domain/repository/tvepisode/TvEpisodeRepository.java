...
public class TvEpisodeRepository extends AbstractRepository implements
    ...
    @SuppressWarnings("rawtypes")
    @Component
    public static class TvEpisodeToImageRepository extends AbstractRepository implements RelationshipRepository<TvEpisode, String, Image, String>, MetaRepository {
